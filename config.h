...
ResourcePref resources[] = {
                ...
                { "blinktimeout", INTEGER, &blinktimeout }, { "bellvolume",   INTEGER, &bellvolume },
...
static Shortcut shortcuts[] = {
        ...
        { ALT | ShiftMask,      XK_Prior,       zoom,           {.f = +1} },
        { ALT | ShiftMask,      XK_Next,        zoom,           {.f = -1} },
        { ALT | ShiftMask,      XK_Home,        zoomreset,      {.f =  0} },
        ...
        { ALT | ShiftMask,      XK_Up,          zoom,           {.f = +1} },
        { ALT | ShiftMask,      XK_Down,        zoom,           {.f = -1} },
        { ALT | ShiftMask,      XK_K,           zoom,           {.f = +1} },
        { ALT | ShiftMask,      XK_J,           zoom,           {.f = -1} },
        { ALT | ShiftMask,      XK_U,           zoom,           {.f = +2} },
        { ALT | ShiftMask,      XK_D,           zoom,           {.f = -2} },
